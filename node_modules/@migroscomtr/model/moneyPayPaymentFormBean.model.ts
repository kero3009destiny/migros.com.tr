...
export interface MoneyPayPaymentFormBean { 
    accessToken: string;
    alternativeProductChoice?: MoneyPayPaymentFormBean.AlternativeProductChoiceEnum;
    bagSelected?: boolean;
    balanceName?: string;
    balanceType?: MoneyPayPaymentFormBean.BalanceTypeEnum;
    balanceValue?: string;
    contactless: boolean;
    note?: string;
    paymentType: MoneyPayPaymentFormBean.PaymentTypeEnum;
    ringDoorbell: boolean;
    transactionId?: string;
    userToken: string;
}
export namespace MoneyPayPaymentFormBean {
