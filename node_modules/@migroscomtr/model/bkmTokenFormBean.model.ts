...
export interface BkmTokenFormBean { 
    alternativeProductChoice?: BkmTokenFormBean.AlternativeProductChoiceEnum;
    bagSelected?: boolean;
    balanceName?: string;
    balanceType?: BkmTokenFormBean.BalanceTypeEnum;
    balanceValue?: string;
    contactless: boolean;
    note?: string;
    paymentType: BkmTokenFormBean.PaymentTypeEnum;
    ringDoorbell: boolean;
}
export namespace BkmTokenFormBean {
