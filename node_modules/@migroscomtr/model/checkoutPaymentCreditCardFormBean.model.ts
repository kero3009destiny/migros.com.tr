...
export interface CheckoutPaymentCreditCardFormBean { 
    alternativeProductChoice?: CheckoutPaymentCreditCardFormBean.AlternativeProductChoiceEnum;
    bagSelected?: boolean;
    balanceName?: string;
    balanceType?: CheckoutPaymentCreditCardFormBean.BalanceTypeEnum;
    balanceValue?: string;
    ...
    installment?: number;
    note?: string;
    paymentType: CheckoutPaymentCreditCardFormBean.PaymentTypeEnum;
    ringDoorbell: boolean;
    secure: boolean;
}
export namespace CheckoutPaymentCreditCardFormBean {
